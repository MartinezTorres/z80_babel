...
.swaps_done:
    ...
    ; quicksort_c(A, i);
    pop     hl          ; HL = A
    call    _quicksort_asm_ped7g_impl

    ; quicksort_c(A + i, len - i);
    ex      de,hl       ; HL = A+i
    pop     de          ; DE = end() (and return it preserved)
    jp      _quicksort_asm_ped7g_impl

_quicksort_asm_ped7g_end::
