	...
	TEST(sieve, language, "Language",
		...
		CASE(sieve, "C", _c , _1, _clang_z80_Oz_50k_mdl, T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL))
		...
		CASE(sieve, "ZIG", _zig , , _Oz_50k_mdl, T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL))

		CASE(sieve, "RUST", _rs , , _Oz_50k_mdl, T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL))

		CASE(sieve, "FORTRAN", _fc , , _Oz_50k_mdl, T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL))
	)
	...
	#define TEST(ALGO_NAME, TEST_NAME, TEXT, CASES) CASES 
	#define CASE(ALGO_NAME, TEXT, SUFFIX1, SUFFIX2, SUFFIX3, NOTES) ALGO_NAME ## SUFFIX1 ## SUFFIX3
	...
	#define CASE(ALGO_NAME, TEXT, SUFFIX1, SUFFIX2, SUFFIX3, NOTES) \
		extern void ALGO_NAME ## SUFFIX1 ## SUFFIX2 ## SUFFIX3(); \
		extern void ALGO_NAME ## SUFFIX1 ## SUFFIX2 ## _end ## SUFFIX3(); \
		ML_REQUEST_B(ALGO_NAME ## SUFFIX1 ## SUFFIX3); 
	...
	#define CASE(ALGO_NAME, TEXT, SUFFIX1, SUFFIX2, SUFFIX3, NOTES) { \
			.name = TEXT, \
			.segment = ML_SEGMENT_B(ALGO_NAME ## SUFFIX1 ## SUFFIX3), \
			.fn_test = (T_FN)ALGO_NAME ## SUFFIX1 ## SUFFIX2 ## SUFFIX3, \
			.fn_begin = (T_FN)ALGO_NAME ## SUFFIX1 ## SUFFIX2 ## SUFFIX3, \
			.fn_end = (T_FN)ALGO_NAME ## SUFFIX1 ## SUFFIX2 ## _end ## SUFFIX3, \
			.notes = NOTES \
		},
	...
	static const T_TEST_CASE test_cases_sieve_language[] = {
		
		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_asm_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_asm_mdl,
			.fn_end = sieve_of_eratosthenes_asm_end_mdl,
...

		{
			.name = "C",
			.segment = ML_SEGMENT_B(sieve_asm_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_asm_llvm_z80_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_asm_llvm_z80_mdl,
			.fn_end = sieve_of_eratosthenes_asm_llvm_z80_end_mdl,
			.notes = T(F_LLVM) + T(OZ) + T(B_LLVM_Z80) + T(MDL)	
		},
		{
			.name = "C",
			.segment = ML_SEGMENT_B(sieve_c_50k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_c_1_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_c_1_50k_mdl,
			.fn_end = sieve_of_eratosthenes_c_1_end_50k_mdl,
		...
		
		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_c_1_clang_z80_Oz_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_c_1_clang_z80_Oz_50k_mdl,
			.fn_end = sieve_of_eratosthenes_c_1_end_clang_z80_Oz_50k_mdl,
...

		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_1_z80_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_1_z80_50k_mdl,
			.fn_end = sieve_of_eratosthenes_cc_1_end_z80_50k_mdl,
			.notes = T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL)
		},

		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_d_1_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_d_1_50k_mdl,
			.fn_end = sieve_of_eratosthenes_d_1_end_50k_mdl,
			.notes =  T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL)
		},
		
		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_zig_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_zig_50k_mdl,
			.fn_end = sieve_of_eratosthenes_zig_end_50k_mdl,
			.notes = T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL)
		},
		
		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_rust_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_rust_50k_mdl,
			.fn_end = sieve_of_eratosthenes_rust_end_50k_mdl,
			.notes = T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL)
		},

		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_fortran_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_fortran__50k_mdl,
			.fn_end = sieve_of_eratosthenes_fortran_end__50k_mdl,
			.notes =  T(F_LLVM) + T(OZ) + T(B_SDCC) + T(T50K) + T(MDL)
		},
	};
	...
	static const T_TEST_CASE test_cases_sieve_mdl[] = {
		...
		
		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_1_z80_50k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_1_z80_50k,
			.fn_end = sieve_of_eratosthenes_cc_1_end_z80_50k,
	...
	static const T_TEST_CASE test_cases_sieve_algo[] = {
		...
		
		{
			.name = "C v2",
			.segment = ML_SEGMENT_B(sieve_c_50k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_c_2_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_c_2_50k_mdl,
			.fn_end = sieve_of_eratosthenes_c_2_end_50k_mdl,
			.notes = T(F_SDCC) + T(B_SDCC) + T(T50K) + T(MDL)
		},

		{
			.name = "C v3",
			.segment = ML_SEGMENT_B(sieve_c_50k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_c_3_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_c_3_50k_mdl,
			.fn_end = sieve_of_eratosthenes_c_3_end_50k_mdl,
			.notes = T(F_SDCC) + T(B_SDCC) + T(T50K) + T(MDL)
		},
...

		{
			.name = "C++ v2",
			.segment = ML_SEGMENT_B(sieve_cc_z80_50k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_2_z80_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_2_z80_50k_mdl,
			.fn_end = sieve_of_eratosthenes_cc_2_end_z80_50k_mdl,
			.notes = T(B_SDCC) + T(T50K) + T(MDL)
		},

		{
			.name = "C++ v3",
			.segment = ML_SEGMENT_B(sieve_cc_z80_50k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_3_z80_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_3_z80_50k_mdl,
			.fn_end = sieve_of_eratosthenes_cc_3_end_z80_50k_mdl,
			.notes = T(B_SDCC) + T(T50K) + T(MDL)
		},
		...
		
		{
			.name = "D v2",
			.segment = ML_SEGMENT_B(sieve_d_50k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_d_2_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_d_2_50k_mdl,
			.fn_end = sieve_of_eratosthenes_d_2_end_50k_mdl,
			.notes = T(B_SDCC) + T(T50K) + T(MDL)
		},

		{
			.name = "D v3",
			.segment = ML_SEGMENT_B(sieve_d_50k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_d_3_50k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_d_3_50k_mdl,
			.fn_end = sieve_of_eratosthenes_d_3_end_50k_mdl,
			.notes = T(B_SDCC) + T(T50K) + T(MDL)
		},
	};
	...
	static const T_TEST_CASE test_cases_sieve_1k_1[] = {
...

		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_1_z80_1k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_1_z80_1k,
			.fn_end = sieve_of_eratosthenes_cc_1_end_z80_1k
		},
	...
	static const T_TEST_CASE test_cases_sieve_1k_2[] = {
...

		{
			.name = "C++ v2",
			.segment = ML_SEGMENT_B(sieve_cc_z80_1k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_2_z80_1k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_2_z80_1k,
			.fn_end = sieve_of_eratosthenes_cc_2_end_z80_1k
		},

		{
			.name = "C++ v3",
			.segment = ML_SEGMENT_B(sieve_cc_z80_1k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_3_z80_1k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_3_z80_1k,
			.fn_end = sieve_of_eratosthenes_cc_3_end_z80_1k
		},
	...
	static const T_TEST_CASE test_cases_sieve_1k_3[] = {
...

		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_c_1_1k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_c_1_1k_mdl,
			.fn_end = sieve_of_eratosthenes_c_1_end_1k_mdl
		},

		{
			.name = "C++ v1 MDL",
			.segment = ML_SEGMENT_B(sieve_cc_z80_1k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_1_z80_1k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_1_z80_1k_mdl,
			.fn_end = sieve_of_eratosthenes_cc_1_end_z80_1k_mdl
		},

		{
			.name = "D v1 MDL",
			.segment = ML_SEGMENT_B(sieve_d_1k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_d_1_1k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_d_1_1k_mdl,
			.fn_end = sieve_of_eratosthenes_d_1_end_1k_mdl
		},
		
		{
			.name = "ZIG MDL",
			.segment = ML_SEGMENT_B(sieve_zig_1k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_zig_1k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_zig_1k_mdl,
			.fn_end = sieve_of_eratosthenes_zig_end_1k_mdl
		},
		
		{
			.name = "RUST MDL",
			.segment = ML_SEGMENT_B(sieve_rs_1k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_rust_1k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_rust_1k_mdl,
			.fn_end = sieve_of_eratosthenes_rust_end_1k_mdl
		},

		{
			.name = "F. MDL",
			.segment = ML_SEGMENT_B(sieve_f_1k_mdl),
			.fn_test = (T_FN)sieve_of_eratosthenes_fortran_1k_mdl,
			.fn_begin = (T_FN)sieve_of_eratosthenes_fortran__1k_mdl,
			.fn_end = sieve_of_eratosthenes_fortran_end__1k_mdl
		},
	};
	...
	static const T_TEST_CASE test_cases_sieve_cpp_1[] = {
...

		{
			...
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_1_z80_2k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_1_z80_2k,
			.fn_end = sieve_of_eratosthenes_cc_1_end_z80_2k
		},

		{
			.name = "C++ 5k",
			.segment = ML_SEGMENT_B(sieve_cc_z80_5k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_1_z80_5k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_1_z80_5k,
			.fn_end = sieve_of_eratosthenes_cc_1_end_z80_5k
		},

		{
			.name = "C++ 10k",
			.segment = ML_SEGMENT_B(sieve_cc_z80_10k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_1_z80_10k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_1_z80_10k,
			.fn_end = sieve_of_eratosthenes_cc_1_end_z80_10k
		},

		{
			.name = "C++ 20k",
			.segment = ML_SEGMENT_B(sieve_cc_z80_20k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_1_z80_20k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_1_z80_20k,
			.fn_end = sieve_of_eratosthenes_cc_1_end_z80_20k
		},
	...
	static const T_TEST_CASE test_cases_sieve_cpp_3[] = {
...

		{
			.name = "C++ 2k",
			.segment = ML_SEGMENT_B(sieve_cc_z80_2k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_3_z80_2k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_3_z80_2k,
			.fn_end = sieve_of_eratosthenes_cc_3_end_z80_2k
		},

		{
			.name = "C++ 5k",
			.segment = ML_SEGMENT_B(sieve_cc_z80_5k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_3_z80_5k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_3_z80_5k,
			.fn_end = sieve_of_eratosthenes_cc_3_end_z80_5k
		},

		{
			.name = "C++ 10k",
			.segment = ML_SEGMENT_B(sieve_cc_z80_10k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_3_z80_10k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_3_z80_10k,
			.fn_end = sieve_of_eratosthenes_cc_3_end_z80_10k
		},

		{
			.name = "C++ 20k",
			.segment = ML_SEGMENT_B(sieve_cc_z80_20k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_3_z80_20k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_3_z80_20k,
			.fn_end = sieve_of_eratosthenes_cc_3_end_z80_20k
		},

		{
			.name = "C++ 50k",
			.segment = ML_SEGMENT_B(sieve_cc_z80_50k),
			.fn_test = (T_FN)sieve_of_eratosthenes_cc_3_z80_50k,
			.fn_begin = (T_FN)sieve_of_eratosthenes_cc_3_z80_50k,
			.fn_end = sieve_of_eratosthenes_cc_3_end_z80_50k
		},
